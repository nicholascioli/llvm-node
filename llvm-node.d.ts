declare namespace llvm {
	...
	class DIBuilder {
		...
		createParameterVariable(scope: _Scope, name: string, argPos: number, file: DIFile, line: number, type: _Type): DILocalVariable;
	...
	class IRBuilder {
		...
		createVAArg(list: Value, type: Type, name?: string): Value;
